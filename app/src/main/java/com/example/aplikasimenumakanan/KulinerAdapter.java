        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (listKuliner.get(position).getNama().equals("Pecel Lele")) {
                    ...
                    intent.putExtra("DESKRIPSI_DEFAULT", "Pecel Lele Jamin Gurih Sambal Mantap deh");
                ...
                if (listKuliner.get(position).getNama().equals("Ayam Geprek Keju")) {
                    ...
                    intent.putExtra("DESKRIPSI_DEFAULT", "cuma di tambah keju");
                ...
                if (listKuliner.get(position).getNama().equals("Kari Ayam")) {
                    ...
                    intent.putExtra("DESKRIPSI_DEFAULT", "kari ayamnya nendang deh pokoknya");
                ...
                if (listKuliner.get(position).getNama().equals("Nasi Goreng Mercon")) {
                    ...
                    intent.putExtra("DESKRIPSI_DEFAULT", "Satu kata PEDES POLL");
                ...
                if (listKuliner.get(position).getNama().equals("Salad Buah")) {
                    ...
                    intent.putExtra("DESKRIPSI_DEFAULT", "di jamin nambah");
                ...
                if (listKuliner.get(position).getNama().equals("Tahu Bulat")) {
                    ...
                    intent.putExtra("DESKRIPSI_DEFAULT", "masih kaya biasa kopong isinya");
